...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-left text-xs leading-normal font-normal text-muted-foreground text-slate-500",
...
type ErrorType = string | { message?: string } | undefined | null
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-xs font-medium text-destructive text-red-500", className)}
      {...props}
    >
      {content}
    </div>
